...
coletada de publicações de redes sociais, métodos lineares de classificação de
texto ainda se mostraram superiores aos classificadores de redes neurais, obtendo
$0,801$ de AUC.
Por fim, analisamos também que a adição de dados da rede de usuários formada por
republicações não foi suficiente para melhor o resultado da análise de sentimento,
contrariando as hipóteses previamente elaboradas.
