...
Finalmente, esses métodos são poderasas ferramentas de análise das redes sociais,
...
Tal empecilho se torna ainda mais notável quando considera-se aplicações que
...
Apesar de menor, a ciência de redes também tém um grande reportório de pesquisa
