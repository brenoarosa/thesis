...
Criada em 2006, a rede conta com 139 milhões de usuários ativos diários segundo
seu relatório trimestral para investidores~\cite{twitterreport19} e está entre
...
\begin{table}[h]
    \begin{center}
        ...
        \hline
        \textbf{\textit{Tweet}} & \textbf{Classe} \\ \hline
        ...
        com emoticons selecionados da Tabela~\ref{tab:supervision_emoticons}.}
...
\textit{emoticons}.
Ademais, não se pode descartar que é possível uma classe tenha subclasses que
...
\citet{ratkiewicz11} que usa características da rede formada por usuários do
