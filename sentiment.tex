...
% anotacao automatica: ressaltar o lado ruim: possivelmente eu tenho subclasses
% de uma class (positivo ou negativo) que nao tem correlação com o objeto que
% escolhi para fazer anotação ruidosa. Essas subclasses se perdem no treinamento
% por supervisao distante. Exemplo: se ironia positiva nao tiver emoticons positivos
% nunca classificaremos ironia como positivo
% Entretanto anotacao automatica alavancou ...
...
% TODO: falar do sucesso de DL em outras areas (visao) e subareas de nlp (traducao)
% citar deep learning nature
...
% pegar referencia em embeddings em grafos
