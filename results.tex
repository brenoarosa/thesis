...
significativo de usuários e possui características comumente observadas em redes
...
sobressai a dispersão observada nas partições do treinamento.
...
Porém, ao aplicar o modelo aos dados de teste, o desempenho do modelo cai
...
Há diversas análises a serem feitas a partir destes resultados.
...
usuários resultou em desempenhos variados para os diferentes modelos, não
