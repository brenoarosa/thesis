...
piores que as técnicas tradicionais SVM e Naïve Bayes.
...
informações do usuário apresentaram resultados variados.
Comparando os resultados a partir do modelo de CNN, vemos que os experimentos
que incluíram os dados do grafo de usuários tiveram média de AUC
