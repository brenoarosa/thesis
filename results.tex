...
Neste algoritmo consideramos o grafo como não-direcionado e retiramos as... +self-loop-


% LLE -> n2v -> GCN

% node2vec, memoria, nao direcionado, nao peso, self loop, escolha dos parametros..
% gcn: mesmo de cima + feature: log do grau + amostragem

% TODO: comentar as limitacoes de cada modelo de embedding de grafo
